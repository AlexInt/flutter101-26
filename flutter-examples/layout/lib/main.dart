...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final examples = <_ExampleItem>[
      _ExampleItem('01', 'Container', '容器布局：padding / margin / decoration', Icons.crop_square, const ContainerPage()),
      _ExampleItem('02', 'Row & Column', '线性布局：水平排列 & 垂直排列', Icons.table_rows, const RowColumnPage()),
      _ExampleItem('03', 'Stack', '层叠布局：组件重叠与定位', Icons.layers, const StackPage()),
      _ExampleItem('04', 'ListView', '列表布局：垂直/水平滚动列表', Icons.list, const ListViewPage()),
      _ExampleItem('05', 'GridView', '网格布局：二维网格排列', Icons.grid_view, const GridViewPage()),
      _ExampleItem('06', 'Flex 弹性布局', 'Expanded / Flexible / Spacer 用法', Icons.swap_horiz, const FlexPage()),
      _ExampleItem('07', 'Wrap', '流式布局：自动换行排列', Icons.wrap_text, const WrapPage()),
      _ExampleItem('08', 'Align & Center', '对齐与居中定位', Icons.center_focus_strong, const AlignmentPage()),
      _ExampleItem('09', '综合实战', '卡片列表页：多种布局组合', Icons.dashboard, const ComprehensivePage()),
    ];
